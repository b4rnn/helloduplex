...
public class ThreeFragment extends  Fragment {
    ...
    private static class VideoCache {
        ...
        public static   SimpleCache getInstance(Context context) {
            //if (sDownloadCache == null) sDownloadCache = new SimpleCache(new File(context.getCacheDir(), "sitcomCache"), new NoOpCacheEvictor(), new ExoDatabaseProvider(context));
            if (sDownloadCache == null) sDownloadCache = new SimpleCache(new File(context.getCacheDir(), "sitcomCache"),   new LeastRecentlyUsedCacheEvictor(1024 * 1024 * 100), new ExoDatabaseProvider(context));
    ...
    private class MyAppAdapter extends BaseAdapter implements ExoPlayer.EventListener{
        ...
        private static final int CAMERA_VIDEO_REQUEST = 1888;
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (rowView == null) {
                ...
                rowView = inflater.inflate(R.layout.sitcom_fragment, parent, false);
            ...
            player = new SimpleExoPlayer.Builder(ThreeFragment.myAppAdapter.context).build();
            ...
            flingContainer.setOnScrollListener(new AbsListView.OnScrollListener() {
                ...
                private void isScrollCompleted() {
                    if (totalItem - currentFirstVisibleItem == currentVisibleItemCount
                        ...
                        player.release();
                        array.clear();
                        dloop = new ThreeFragment.Dataloop();
                        dloop.GenerateData();
                    }
                }
            });
