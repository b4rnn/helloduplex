...
public class OneFragment extends  Fragment {
    ...
    private static class VideoCache {
        ...
        public static   SimpleCache getInstance(Context context) {
            if (sDownloadCache == null) sDownloadCache = new SimpleCache(new File(context.getCacheDir(), "standupCache"),   new LeastRecentlyUsedCacheEvictor(1024 * 1024 * 100), new ExoDatabaseProvider(context));
    ...
    private class MyAppAdapter extends BaseAdapter implements ExoPlayer.EventListener{
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (rowView == null) {
                ...
                rowView = inflater.inflate(R.layout.standup_fragment, parent, false);
                                ...
                                if (c.moveToFirst()) {
                                    ...
                                    if (DownloadManager.STATUS_SUCCESSFUL == c
                                        ...
                                        if (uriString != null) {
                                            ...
                                            _intent.setPackage("com.twitter.android");
            ...
            //Toast.makeText(getContext(),parkingList.get(position).getImagePath(), Toast.LENGTH_SHORT).show();
            // ConcatenatingMediaSource concatenatingMediaSource = new ConcatenatingMediaSource(hlsMediaSource);
            player = new SimpleExoPlayer.Builder(OneFragment.myAppAdapter.context).build();
                    ...
                    new  ExoPlayer.EventListener(){
                        ...
                        public void onPlayerStateChanged(boolean playWhenReady, int playbackState) {
                            ...
                            switch(playbackState) {
                                ...
                                default:
                                    //viewHolder.videoBar.setVisibility(View.GONE);
                                    break;
                            }
                        }
                        @Override
